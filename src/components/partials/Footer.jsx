      ...
      <footer className='bg-black/90 pt-12'>
        <div className='container'>
          <div className='grid grid-cols-1 gap-8 border-b border-b-white/20 md:grid-cols-2 lg:grid-cols-4'>
            ...
            <div>
              <h5 className='mb4 text-white'>Quick Links</h5>
          ...
          <div className='flex flex-col items-center py-8 text-white/70 justify-between md:flex-row'>
            <small>&copy; 2025 MyApp. All right reserved.</small>
